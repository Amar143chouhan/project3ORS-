       ...
       <h3><font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></h3>
            ...
            <table width="100%" align="center">
                <tr>
                    ...
                    &emsp; 
                    <label> Filter by Result :</font></label> 
                    <%
							...
							String htmlList1 = HTMLUtility.getList("result",ServletUtility.getParameter("result", request), map1);
						%> <%=htmlList1%>
                    
                    <label> Filter by Total :</font></label> 
                    <%
							...
							String htmlList = HTMLUtility.getList("tcheck",ServletUtility.getParameter("tcheck", request), map);
						%> <%=htmlList%>
                    
                    <input type="number" name="tf" placeholder="Enter total marks" value="<%=ServletUtility.getParameter("tf", request)%>">
                    &emsp; 
