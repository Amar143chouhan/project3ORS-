...
public class MyProfileCtl extends BaseCtl{
    ...
    protected void doGet(HttpServletRequest request,
		...
		/*
		 * long id = UserBean.getId(); String op =
		 * DataUtility.getString(request.getParameter("operation"));
		 * 
		 * // get model UserModel model = new UserModel(); if (id > 0 || op != null) {
		 * UserBean bean; try { bean = model.findByPK(id); System.out.println(bean);
		 */               
